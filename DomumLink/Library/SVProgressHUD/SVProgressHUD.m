...
- (id)initWithFrame:(CGRect)frame {
    ...
    if ((self = [super initWithFrame:frame])) {
        ...
        SVProgressHUDForegroundColor = [UIColor colorWithRed:90/255.0f green:171/255.0f blue:227/255.0f alpha:1.0f]; //[UIColor colorWithRed:45/255.0f green:167/255.0f blue:195/255.0f alpha:1.0f]; //
...
- (void)drawRect:(CGRect)rect {
    ...
    } else if (self.maskType == SVProgressHUDMaskTypeGradient) {
